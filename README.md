...
Méthodes publiques
-Constructeurs conformes au main fourni, avec l’ordre des paramètres suivant :poids, couleur, âge, espérance de vie.
Les deux derniers paramètres ont pour valeurs par défaut : 0 et 36.
Ces constructeurs affichent : "Une nouvelle souris !"

-Constructeur de copie qui affiche : "Clonage d’une souris !"
La souris clonée possède les mêmes caractéristiques sauf son espérance de vie qui est réduite aux 4/5 de celle d’origine

-Destructeur affiche: "Fin d’une souris..."

-Méthode afficher() qui affiche les caractéristiques sous le format :
"Une souris <couleur> [, clonee,] de <age> mois et pesant <poids> grammes"
(la partie , clonee, n’apparaît que si la souris est clonée)

-Méthode vieillir qui augmente l’âge de 1 si la souris est clonée et dépasse la moitié de son espérance de vie, elle devient verte.
cette méthode doit être publique

-Méthode evolue qui fait vieillir la souris jusqu’à atteindre son espérance de vie
